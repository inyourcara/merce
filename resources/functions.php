...
<div class="col-sm-4 col-lg-4 col-md-4">
    <div class="thumbnail" >
        <a href="item.php?id={$row['product_id']}"><img src="../resources/{$product_image}" style="height:230px;" alt=""></a>
        <div class="caption">
...
function get_cat_main_image() {
    $query = query("SELECT cat_img FROM categories WHERE cat_id =" .escape_string($_GET['id']). " ");
    confirm($query);
    ...
    while ($row = fetch_array($query)) {
        ...
        <img src="../resources/{$cat_img}" alt="" style="width:100%;">

<h1 style="color:white;">Todays Bike Shop</h1>
<p style="color:white;">Get a bicycle. You will not regret it, if your live.</p>
...
$product = <<<DELIMETER
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    <img src="../resources/{$product_image}" alt="" >
                    <div class="caption">
                        <h3 style="font-size:16px;">{$row['product_title']}</h3>
                        <p style="font-size:16px;">{$row['short_desc']}</p>
                        <p>
